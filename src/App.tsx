...
import { Wallet, BarChart3, CreditCard, MessageSquare, Home, Target } from 'lucide-react'
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <Card className="p-8 max-w-md w-full mx-4">
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold mb-2">Hub Financiero Personal</h1>
            <p className="text-muted-foreground mb-6">
              Gestiona tus finanzas de manera intuitiva y privada
            </p>
            <p className="text-sm text-muted-foreground">
              Inicia sesión para acceder a tu hub financiero
            </p>
          </div>
        </Card>
      </div>
